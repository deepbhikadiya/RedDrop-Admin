...
class _LoginScreenState extends State<LoginScreen> {
  ...
  void initState() {
    ...
    super.initState();
    // loginController.idController.text="deep@gmail.com";
    // loginController.passwordController.text="1234&Abcd";
  }
                          ...
                          onTap: () {
                            if (formKey.currentState!.validate()) {
                              loginController.login(context,
                                  email: loginController.idController.text, password: loginController.passwordController.text);
                            }
                          },
                        );
                      }),
