...
import 'package:web_redrop/module/dashBoardView/reports/report_controller.dart';
...
class _ReportScreenState extends State<ReportScreen> {
  ...
  Future<void> generateExcelFile(DateRange dateRange) async {
    ...
    for (int i = 0; i < snapshot.docs.length; i++) {
      ...
      String donationDateString =
          '${donationDate.year}-${donationDate.month.toString().padLeft(2, '0')}-${donationDate.day.toString().padLeft(2, '0')}';
  ...
  // ),
                      ...
                      return DataTable2(
                        ...
                        rows: filteredUsers.map((DocumentSnapshot document) {
                          ...
                          return DataRow(
                            onLongPress: () {},
                            cells: [
                              DataCell(Text((data["donor"]['first_name'] ?? "") +
                                      " " +
                                      (data["donor"]['middle_name'] ?? "") +
                                      " " +
                                      data["donor"]['last_name'] ??
                                  "")),
                              DataCell(Container(
                                width: 100,
                                decoration: BoxDecoration(
                              ...
                              DataCell(Text((data["seeker"]['first_name'] ?? "") +
                                      " " +
                                      (data["seeker"]['middle_name'] ?? "") +
                                      " " +
        ...
        // Padding(
        //   padding: const EdgeInsets.only(right: 40.0, left: 20, top: 30, bottom: 0),
        //   child: Column(
        //     crossAxisAlignment: CrossAxisAlignment.start,
        //     children: [
        //       Row(
